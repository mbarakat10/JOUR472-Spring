...
A2: **2020, they are generally in order of time, as the years get bigger, the total amounts get bigger too, why is 2015 so high up?**
...
A3. **Some companies have different parts of their names abbreviated differently making them show up in more than one row, exs: Whiting Turner Contracting Co vs. Whiting Turner Contracting Company, Ayers Saint Gross Inc vs Ayers Saint Gross, and Grimm + Parker Architects vs Grimm and Parker Architects. To clean this data, I might use filter and str_detect to detect the main words in the names of companies to combine all of the identical ones into the same row**
...
A4: **Overall, over time, the total amount of stem cell research funding decreased. In 2020, it was nearly half of what it was in 2009.**
