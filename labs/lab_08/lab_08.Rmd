...
Describe the pattern of results; you may want to look at the data to dig into particular outliers. **Week 28 in the year has the highest number of calls, which falls in July. The outlier – also the week with the lowest number of calls – only has 4 but it is the final week of the year, so that makes sense. The data peaks on the line chart in the middle of the year.**
