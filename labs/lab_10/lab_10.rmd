...
county_outages_merge <- md_counties |> inner_join(county_outages_march2023, join_by(name==county))
```
...
ev_counties <- md_counties |> inner_join(ev_2020_2023, join_by(name==county))
```
