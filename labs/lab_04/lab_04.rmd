...
facebook_expenses <- media_expenses_clean |>
...
**A2.** Friends of Ashwani Jain - running for U.S House of Reps, most of the ads include multimedia, Franchot and Anderson-Walker for Maryland Slate - running for MD governor and liutenant governor, Friends of Peter Franchot - running for MD governor, Friends of Billy Boniface - running for Harford County Executive, Jon Baron for Maryland - running for MD governor, WFP National Pac - Working Families Party, third party that advocates for workers, King and Siri for Maryland Slate - candidates for governor and liutenant governor, John King for Governor - a candidate running for Maryland governor, Friends of Amanda Fiedler - running for Anne Arundel County Council District 5, Firefighters of Frederick County for Collective Bargaining - firefighters in Frederick County advocating for collective bargaining aka unionization rights
...
**A3. Wes Moore/Aruna Miller and Dan Cox/Gordana Schifanelli are missing from the list. According to Facebook's ad library, the two campaigns did run Facebook ads. The biggest recipients of media expenses by Moore, the Democratic primary winner for governor, were SKDK and Foglamp.**
...
**A4. More PACs invested in online advertising than campaigns did on Facebook. No**

```{r}
online_ads_expenses <- media_expenses_clean |>
  filter(expense_purpose == 'Online Advertising') |>
  group_by(committee_name) |>
  summarise(
    total_online = sum(amount)
  ) |>
arrange(desc(total_online))
```
...
**A5. From the data we've examined, we know that the top spenders on Facebook advertising were mostly Democratic candidates, most of whom lost the election. I found it interesting that Wes Moore spent less money on Facebook compared to other media expenses.**
