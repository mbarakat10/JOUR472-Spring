...
-   **Sentence text**: What decade had games owned by the most users?
-   **Analysis summary**:
...
board_game_owner_decades |>
  mutate(
    ...
    avg_ratings = (total_owners/sum(total_owners))*100
  ) |>
  arrange(desc(avg_ratings))
```
