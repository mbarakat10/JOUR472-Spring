...
**Task** Write and run code to answer our original question: which zip code has gotten the most amount of money from the Maryland Tourism Board? Does that zip code make sense to you? **20001, this doesn't make too much sense because this is a zip code in Washington DC, could be because a lot of companies/organizations are based in MD**
