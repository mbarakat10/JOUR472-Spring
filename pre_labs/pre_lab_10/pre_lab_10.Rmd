...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer Zip codes, zip name, existing, shape length and area, geometry**
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer the zip code with the areas and shape of that zip code area**
...
**Task** Run the following code. Describe the output in the space below. **Answer: A map of Maryland divided by zip codes**
...
**Task** Run the following code. Describe the output in the space below. **Answer: loaded US countywide data**
...
**Task** Run the following code. Describe the output in the space below. **Answer: narrowed down MD counties and their geography**
...
**Task** Run the following code. Describe the output in the space below. **Answer: A Maryland map divided by county**
...
**Task** Run the following code. Describe the output in the space below. **Answer: A Maryland map with zip code divisions over the county divisions**
...
**Task** Run the following code. Describe the output in the space below. **Answer: A table with the zip codes and how many foreclosures happened in those zip codes in March 2023**
...
**Task** Run the following code. Describe the output in the space below. **Answer: It joined the MD zip code data with the column for the March foreclosures**
...
**Task** Run the following code. Describe the output in the space below. **Answer: A Maryland map divided by zip code with colors ranging from dark to light of how many foreclosures there are**
...
**Task** Run the following code. Describe the output in the space below. **Answer: The rate of foreclosures per each MD county on a map with counties labeled**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer: different rates from maps before, Most of the region has a rate of less than 2 excluding one county. Several counties have a rate less than 0.736 as well**
