...
**Task** Run the following code and describe the dataframe it outputs. **Answer: A dataframe with each state's per pupil education spending in 2021, GDP growth 2021, population change in 2021 and their vote for either Trump or Biden in 2020.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer: There is a slight positive correlation between the population change in 2021 and the GDP growth in 2021.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer: There is a very weak negative correlation between the per pupil education spending in 2021 and the GDP growth in 2021.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer: The population change and GDP growth have a slight positive correlation. The population change and per pupil education spending have a slight negative correlation. The connection between GDP growth and per pupil education spending is a very weak negative correlation.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: The t value, df value, p value, the confidence interval and correlation coefficient.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: The correlation coefficient is what we found before. The p value in this case is much higher at 0.6795.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer: The states won by Biden, on average, had higher GDP growth and per pupil education spending. But states won by Trump, on average, had a higher population growth.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: A two sample t-test with the t value, p value, confidence interval and the two means for Biden and Trump.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: A very small p value and very high t value, suggesting a meaningful statistical finding.**
