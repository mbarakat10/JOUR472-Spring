...
In the space below, write the data type for the "id" column and the "seats" column (it's in light gray, offset by \< \>). **Answer "id" column data type is \<chr\>, "seats" is \<dbl\>**
...
1.  How do different departments compare to each other in terms of average number of seats?

2.  What exactly does the "arrange" function do?

3.  How does saving in R Studio work exactly?
