...
**Task** Run the following code and describe the dataframe it outputs. **Answer: A table with three columns of date, title and url of Cardin's releases.**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer: It considered "Dog" and "dog" as unique words because of capitalization**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer: The result was one column with 1360638 unique words from the text column in releases. Some of the words look to be repeated.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer: It's interesting because most of the words used the most have no significance or are just filler words, like "the" and "of."**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer: It's more interesting than before because the top used words have significance and represent the topics and issues Cardin addresses most in releases, like health and insurance.**
...
**Task** Run the following code and describe the results. **Answer: The top 10 words in each year are very similar.**
...
**Task** Run the following code and describe the results. **Answer: The top results are health care, pre existing and covid 19, which are all related to healthcare and health issues that Cardin frequently sends releases about.**
