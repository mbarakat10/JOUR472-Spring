...
```{r echo=FALSE}
census_api_key("7eeb7101193b9c08d0a867c4ea2547ecf86cd878", install=TRUE)
```
...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer Nevada, approx. 35% increase**
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer: Statistical significance between median household incomes by county in Maryland**
