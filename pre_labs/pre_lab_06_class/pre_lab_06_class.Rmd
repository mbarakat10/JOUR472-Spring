...
**Task** Load the four CSV population estimate files. Do they have the same column structure? **Answer Yes**
...
**Task** Combine the four files into a single data frame using the bind_rows function. Add a description of what this code does to your reference notebook. **It combines all of the data into one sheet with all of the same variables. There are two "total" columns because the names are not the same**
...
**Task** Load the Maryland demographic data and examine it. What kind of information does it contain? **Answer the demographics of the population of each county by age and race**
